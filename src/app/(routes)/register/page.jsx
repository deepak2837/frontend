...
const Register = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen w-full bg-white pt-8">
      <div
        className="bg-white p-6 w-full max-w-sm shadow-lg border-4"
        style={{
          borderImage: "linear-gradient(90deg, #FE6B8B 0%, #FF8E53 100%) 1",
          borderRadius: "2rem", // ensures all 4 corners are curved
        }}
      >
