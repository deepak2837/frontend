        ...
        {ServicesData.map(({ titleone, titletwo, link, itemclass, imgURL }, index) => {
          ...
          return (
            <a
              key={index}
              href={link}
              className={`w-[90%] p-6 rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 border border-b-4 border-[#e48551] ${gradientClass} no-underline`}
              style={{
                borderRadius: '45px',
              }}
            >
              <div className="flex flex-col md:flex-row items-center justify-between">
                <div className="mb-4 md:mb-0 w-full space-y-2">
                  ...
                  <div className={`flex items-center gap-2 font-medium ${index % 2 === 0 || isStudyNotes ? 'text-white' : 'text-black'}`}>
